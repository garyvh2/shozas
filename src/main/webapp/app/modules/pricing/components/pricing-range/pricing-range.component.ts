...
@Component({
    selector: 'jhi-pricing-range',
    templateUrl: './pricing-range.component.html',
    styleUrls: ['./pricing-range.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => PricingRangeComponent),
            multi: true
        }
    ]
})
export class PricingRangeComponent implements ControlValueAccessor {
    @Output()
